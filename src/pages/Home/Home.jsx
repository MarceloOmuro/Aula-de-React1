...
function Home() {
  ...
  const srcImage =
    "https://s2.glbimg.com/QxgfZZ0KaNp-BRgg_Pfile-2-WM=/0x468:1536x1332/fit-in/629x354/middle/smart/filters:strip_icc():strip_exif():format(webp)/i.s3.glbimg.com/v1/AUTH_bc8228b6673f488aa253bbcb03c80ec5/internal_photos/bs/2023/3/8/IFfzYCRkGLGL7jqP5YAg/fzqkz10wwaqujd6.jfif";
  ...
  return (
    <>
      ...
      <button onClick={handleClick1}>Ver Vivo</button>
      {renderizarQtdNoticias()}
      {temNoticia ? (
        <CardNoticia titulo={tituloNoticia} srcImage={srcImage} />
      ) : (
